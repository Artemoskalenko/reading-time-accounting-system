...
urlpatterns = [
    ...
    path('start-reading-session/<int:pk>/', views.StartReadingSessionAPIView.as_view(), name='start_reading_session'),
    path('end-reading-session/', views.EndReadingSessionAPIView.as_view(), name='end_reading_session'),
